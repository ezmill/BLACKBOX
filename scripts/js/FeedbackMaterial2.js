function FeedbackMaterial(RENDERER, SCENE, CAMERA, TEXTURE, ORIGINALTEXTURE, SHADERS) {
    ...
    this.mesh;
    // this.origTex = THREE.ImageUtils.loadTexture("assets/textures/test.jpg");
    ...
    this.setUniforms = function() {
        for (var i = 0; i < this.fbos.length; i++) {
            ...
            if (this.fbos[i].material.uniforms["origTex"]) this.fbos[i].material.uniforms["origTex"].value = ORIGINALTEXTURE;
            if (this.material.uniforms["origTex"]) this.material.uniforms["origTex"].value = ORIGINALTEXTURE;
        }
    }
